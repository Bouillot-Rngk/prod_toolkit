...
async function initUi() {
  ...
  const location_eog = `http://${server}/pages/op-module-league-end-of-game/gfx`
  const location_draft = `http://${server}/pages/op-module-league-champselect-ui/`

  const apiKey = await window.constants.getApiKey()

  document.querySelector(
    '#embed-copy-draft'
  ).value = `${location_draft}/champselect.html${
    apiKey !== null ? '?apikey=' + apiKey : ''
  }`
  document.querySelector('#draft-gfx').src = `${location_draft}/champselect.html${
    apiKey !== null ? '?apikey=' + apiKey : ''
  }`
  ...
  document.querySelector(
    '#embed-copy-replay'
  ).value = `${location}/replay-gfx.html${
    apiKey !== null ? '?apikey=' + apiKey : ''
  }`
  document.querySelector('#replay-gfx').src = `${location}/replay-gfx.html${
    apiKey !== null ? '?apikey=' + apiKey : ''
  }`
  ...
  document.querySelector(
    '#embed-copy-eog'
  ).value = `${location_eog}/all-in-one.html${
    apiKey !== null ? '?apikey=' + apiKey : ''
  }`
  document.querySelector('#eog-gfx').src = `${location_eog}/all-in-one.html${
    apiKey !== null ? '?apikey=' + apiKey : ''
  }`

  document.querySelector(
    '#embed-copy-ingameBU'
  ).value = `${location}/ingameBU-gfx.html${
    apiKey !== null ? '?apikey=' + apiKey : ''
  }`
  document.querySelector('#ingameBU-gfx').src = `${location}/ingameBU-gfx.html${
    apiKey !== null ? '?apikey=' + apiKey : ''
  }`
